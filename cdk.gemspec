...
Gem::Specification.new do |spec|
  ...
  spec.description   = "Cloudera's Development Kit ruby integration. CDK helps you solve problems using Hadoop.\n"
  spec.summary       = "JRuby integration for the Cloudera Development Kit (CDK)"
  spec.homepage      = "http://github.com/cloudera/cdk-ruby"
